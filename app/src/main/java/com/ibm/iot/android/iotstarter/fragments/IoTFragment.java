...
public class IoTFragment extends IoTStarterFragment {
    ...
    public void onResume() {
      ...
      //  initializeIoTActivity();
        ...
        updateViewStrings();
        ed1=(EditText)getActivity().findViewById(R.id.messageidValue2);
        ed2=(EditText)getActivity().findViewById(R.id.communicatoridValue2);
        ed3=(EditText)getActivity().findViewById(R.id.fsblidValue2);
        ed4=(EditText)getActivity().findViewById(R.id.messagetypeValue2);
        /*
        ((EditText) getActivity().findViewById(R.id.messageidValue2)).setText("");
        ((EditText) getActivity().findViewById(R.id.communicatoridValue2)).setText("");
        ((EditText) getActivity().findViewById(R.id.fsblidValue2)).setText("22446688");
        ((EditText) getActivity().findViewById(R.id.messagetypeValue2)).setText("");
*/
        b1 = (Button) getActivity().findViewById(R.id.keepalive);

        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*
                //String messageData = MessageFactory.getBristerPing(ed1.toString(),ed2.toString(),ed3.toString(),Integer.parseInt(ed4.toString()),ed5.toString());
                ...
                mqtt.publish(TopicFactory.getEventTopic(Constants.TEXT_EVENT)," hii",false,0);
                */
                if(app.isConnected()) {
                    ...
                    app.BristerPing(ed1.getText().toString(), ed2.getText().toString(), ed3.getText().toString(), ed4.getText().toString());
                    app.setSend(0);
                }
            }
        });
