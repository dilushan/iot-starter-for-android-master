...
public class MessageFactory {
    ...
    public static String getBristerPing(String messageId,String communicatorId,String fsblId,int messageType,String time){
        String data="{\"d\":{\"messageId\":\""+messageId+"\",\"communicatorId\":\""+communicatorId+"\",\"fsblId\":\""+fsblId+"\",\"messageType\":"+messageType+",\"time\":\""+time+"\"}}";

        return data;
    }
    public static String getBristerBreak(String messageId,String communicatorId,String fsblId,int messageType,String time,String slot){
        String data="{\"d\":{\"messageId\":\""+messageId+"\",\"communicatorId\":\""+communicatorId+"\",\"fsblId\":\""+fsblId+"\",\"messageType\":"+messageType+",\"timestamp\":\""+time+"\",\"slotNumber\":\""+slot+"\"}}";
