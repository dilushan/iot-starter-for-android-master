...
public class IoTStarterApplication extends Application {
    ...
    String messageId,communicatorId,fsblId,time,slot;
    int messageType;
    ...
    public void BristerPing(String messageId,String communicatorId,String fsblId,String messageType){
    ...
    public void BristerBreak(String messageId,String communicatorId,String fsblId,String messageType,String time,String slot){
        this.messageId=messageId;
        this.communicatorId=communicatorId;
        this.fsblId=fsblId;
        this.messageType=Integer.parseInt(messageType);
    ...
    public String getBristerPing(){
        SimpleDateFormat s = new SimpleDateFormat("yyyy-MM-dd'T'hh:mm:ssZ");
       s.setTimeZone(TimeZone.getTimeZone("UTC"));
        String format = s.format(new Date());
        this.time=format;
        return MessageFactory.getBristerPing(messageId,communicatorId,fsblId,messageType,time);
    }
    public String getBristerBreak(){
        SimpleDateFormat s = new SimpleDateFormat("yyyy-MM-dd'T'hh:mm:ssZ");
        s.setTimeZone(TimeZone.getTimeZone("UTC"));
        String format = s.format(new Date());
        this.time=format;
        return MessageFactory.getBristerBreak(messageId,communicatorId,fsblId,messageType,time,slot);
    }
