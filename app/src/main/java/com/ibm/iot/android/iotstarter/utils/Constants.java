...
public class Constants {
    ...
    public static final String IOT_LABEL = "BLISTER PING";
    public static final String LOG_LABEL = "BLISTER BREAK";
    ...
    public final static String ACCEL_EVENT = "bristerPing";
    public final static String CONNECT_EVENT = "connect";
