...
public class LoginFragment extends IoTStarterFragment {
    ...
    protected void updateViewStrings() {
        ...
        /*
        ((EditText) getActivity().findViewById(R.id.organizationValue)).setText("6x53kd");
        ((EditText) getActivity().findViewById(R.id.deviceIDValue)).setText("112233112233");
        ((EditText) getActivity().findViewById(R.id.authTokenValue)).setText("ipaFt*@0zI6URQGWkc");*/
    ...
    private void handleActivate() {
        Constants.DEVICE_TYPE=((EditText) getActivity().findViewById(R.id.deviceTypeValue)).getText().toString();
